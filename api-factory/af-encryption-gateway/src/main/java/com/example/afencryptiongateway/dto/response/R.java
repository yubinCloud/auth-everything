package com.example.afencryptiongateway.dto.response;
...
public class R<T> implements Serializable {
    ...
    public static R<Object> forbidden(String msg) {
    ...
    public static R<Object> unavailable(String msg) {
        return new R<>(SERVICE_UNAVAILABLE, msg, null);
    }
